 ...
 * biome-ignore-all lint/style/noNonNullAssertion: Leveraging index signature which requires non-null assertions
 */
...
import {
  ...
  Deprecate,
  withDeprecation,
} from '../../src/standard/tombstone.js';
...
describe('Tombstone', () => {
  ...
  describe('Decorator API', () => {
    ...
    describe('Class Method Decoration', () => {
    ...
    describe('Class Accessor Decoration', () => {
      ...
      test('Decorating a getter-only property should not incur a side-effect of introducing a setter', () => {
        ...
        expect(fakeMeter.counters['tombstones']!.total).toBe(0);
      });
  ...
  describe('Plain Function Decoration', () => {
